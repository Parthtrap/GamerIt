...
//   //original function
  ...
  debugMode ? console.log("Get All Communities -> Got all Communities !!") : "";
...
export const createCommunity = async (req, res) => {
  ...
  debugMode
    ? console.log("Creating Community -> Community Created Successsfully !!")
    : "";
...
export const deleteTag = async (req, res) => {
  ...
  try {
    found = await community.findOne({ name: communityname });
    if (!found) {
      debugMode ? console.log("Delete Tag -> Community Doesn't Exist") : "";
      res.status(404).json({ message: "Community Doesn't Exist" });
      return;
    }
    let obj = found.tags.find((o) => o.name === name);
...
export const updateCommunityProfilePic = async (req, res) => {
  ...
  if (foundcommunity.matchedCount == 0) {
    ...
    debugMode
      ? console.log("Update Community Profile Pic -> No Community was Updated")
      : "";
    res.status(400).json({ message: "No Community was Updated" });
    return;
  }
...
export const updateCommunityBannerPic = async (req, res) => {
  ...
  try {
    ...
    debugMode ? console.log("Update Banner Profile Pic -> " + err.message) : "";
    res.status(500).json({ message: err.message });
    return;
  }
  if (foundcommunity.matchedCount == 0) {
    ...
    debugMode
      ? console.log("Update Community Banner Pic -> No Community was Updated")
      : "";
    res.status(400).json({ message: "No Community was Updated" });
    return;
  }
...
export const makeModerator = async (req, res) => {
  ...
  try {
    ...
    if (!founduser) {
      debugMode ? console.log("Make Moderator -> User Doesn't Exist") : "";
    ...
    if (!found) {
      debugMode ? console.log("Make Moderator -> Community Doesn't Exist") : "";
      res.status(404).json({ message: "Community Doesn't Exist" });
      return;
    }
  ...
  if (found.matchedCount == 0) {
    ...
    debugMode ? console.log("Make Moderator -> No Community was Updated") : "";
    res.status(400).json({ message: "No Community was Updated" });
    return;
  }
  debugMode
...
export const removeModerator = async (req, res) => {
  ...
  try {
    ...
    if (!obj) {
      debugMode
        ? console.log("Remove Moderator -> User is Already Not a Moderator")
        : "";
      res.status(400).json({
...
export const addParameter = async (req, res) => {
  ...
  try {
    found = await community.findOne({ name: communityName });
    if (!found) {
      debugMode ? console.log("Add Parameter -> No Such Community Exists") : "";
      res.status(404).json({ message: "No Such Community Exists" });
      return;
    }
    let obj = found.parameters.find((o) => o.name == name);
    if (obj) {
      debugMode ? console.log("Add Parameter -> Parameter Already Exists") : "";
  ...
  if (found.matchedCount == 0) {
    debugMode ? console.log("Add Parameter -> Community Doesn't Exist") : "";
    res.status(404).json({ message: "Community Doesn't Exist" });
    return;
  }
  debugMode ? console.log("Add Paramater -> Parameter Added Sucessfully") : "";
