...
const CreatePostSearchBar = () => {
    return (
        <>
            ...
            >
                <input type="text" placeholder="Create Post" className="w-full block flex-grow h-10 px-2 text-lg text-tprimary bg-fill-bg rounded-l-xl  focus:outline-none " />
                <Link to='/createpostpage' className="flex relative  items-center justify-center w-10 h-10 text-2xl text-tprimary bg-fill-bg  hover:text-fill hover:bg-fill-base focus:outline-none focus:text-fill focus:bg-fill-base">
