...
export default function NewCommunityModel(props) {
    return(
        <div className="">
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-25 z-100 backdrop-blur-sm">
                <div className="container p-2 mx-auto mt-16 border border-gray-700 rounded-lg shadow-md bg-fill md:max-w-xl">
                    ...
                    <div className={"p-2 mx-5 mb-5 overflow-scroll rounded-lg shadow-lg scrollbar-hide md:mx-16  " }>

                    <div class="mb-2">
                        <label for="large-input" class="text-tprimary block mb-2 text-sm font-medium  ">Enter New Community Title</label>
